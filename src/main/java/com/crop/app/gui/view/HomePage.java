...
public class HomePage {
    ...
    public static Scene createHomePage() {
        ...
        Image logoImage = new Image(ResourceLoader.getIcon("home-page-logo.jpg"));
        ImageView logoView = new ImageView(logoImage);
        logoView.setFitWidth(300);
        logoView.setFitHeight(300);

        Label welcomeLabel = new Label("Welcome to Crop Disease Identification Application");
        welcomeLabel.setStyle("-fx-font-size: 20px; -fx-font-weight: bold; -fx-text-fill: #1a5c1a;");
        ...
        // Button click action
        startButton.setOnAction(HomePageController.startButtonHandler);
